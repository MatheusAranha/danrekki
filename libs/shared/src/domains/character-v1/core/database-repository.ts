...
export abstract class CharacterV1DatabaseRepository {
  ...
  abstract update(id: string, updates: Partial<Pick<ICharacterV1Dto, 'name' | 'clan_id' | 'available_dt' | 'elemental_affinities' | 'updated_at'>>, session?: RepositorySession): Promise<ICharacterV1Dto | null>;
