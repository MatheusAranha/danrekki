...
export abstract class JutsuV1DatabaseRepository {
  ...
  abstract update(id: string, updates: Partial<Pick<IJutsuV1Dto, 'name' | 'jutsu_rank_id' | 'release_id' | 'elements' | 'components' | 'duration' | 'description' | 'updated_at'>>): Promise<IJutsuV1Dto | null>;
