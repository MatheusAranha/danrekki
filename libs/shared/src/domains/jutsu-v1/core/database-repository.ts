...
export abstract class JutsuV1DatabaseRepository {
  ...
  abstract findByKeywordId(keywordId: string): Promise<IJutsuV1Dto[]>;
  ...
  abstract update(id: string, updates: Partial<Pick<IJutsuV1Dto, 'name' | 'jutsu_rank_id' | 'keyword_ids' | 'elements' | 'components' | 'duration' | 'description' | 'updated_at'>>): Promise<IJutsuV1Dto | null>;
